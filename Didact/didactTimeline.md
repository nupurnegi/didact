    ...
    <div class="timeline">
      ...
      <div class="container right">
        <div class="content">
            ...
            <a class="button is-dark is-medium" title="Generate API key" href="didact://?commandId=extension.sendToTerminal&text=nodejs%20terminal%7Cgenerate-api-token%7Cnodejs%20terminal|cd%20${CHE_PROJECTS_ROOT}/Churn-Prediction;ibmcloud%20iam%20api-key-create%20ApiKey-bankLoan%20-d%20'this is API key for bankLoan'%20--file%20${CHE_PROJECTS_ROOT}/Churn-Prediction/key_file">Generate API key</a>
        </div>
      </div>
      <div class="container right">
        <div class="content">
          ...
          <img src = "ChurnPred1.png" width = "750" height= "750"></br></br></br>
          <p>Step 2 : Next click on <b>New deployment space +</b> button as shown in the figure below.</p>
          <img src = "ChurnPred2.png" width = "750" height= "750"></br></br></br>
          <p>Step 3 : If prompted with the below screen, click on <b>Create a space from a file</b>.</p>
          <img src = "ChurnPred3.png" width = "750" height= "750"></br></br></br>
          <p>Step 4 : Give your deployment space a name and remember the name for later use. Select the storage and machine learning service and click <b>Create</b></p>
          <img src = "ChurnPred4.png" width = "750" height= "750"></br>
        </div>
      </div>
      <div class="container right">
        <div class="content">
          <p>Add the Deployment Space Name to the .env file.</p>
           <a class="button is-dark is-medium" title="Open File" href="didact://?commandId=extension.openFile&text=nodejs%20terminal%7Cconfigure-application%7C${CHE_PROJECTS_ROOT}/Churn-Prediction/.env">Open File</a>
        </div>
      </div>
      <div class="container right">
        <div class="content">
      ...
      <div class="container right">
        <div class="content">
          <p>Click on the below button to train and deploy the model to the deployment space.</p>
           <a class="button is-dark is-medium" title="Open File" href="didact://?commandId=extension.sendToTerminal&text=nodejs%20terminal%7Cdeploy-model%7Cnodejs%20terminal|python3.8%20DeployModel/deployMLModel.py">Deploy Model</a>
        </div>
      </div>
        <div class="container right">
            <div class="content">
